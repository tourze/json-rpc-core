...
class OnBatchSubRequestProcessingEventTest extends TestCase
{
    ...
    public function testEventDocumentation(): void
    {
        ...
        $this->assertStringContainsString('before that a sub request will be processed', $docComment);
    }
    ...
    public function testEventSequence(): void
    {
        ...
        $processedEvent = new \Tourze\JsonRPC\Core\Event\BatchSubRequestProcessedEvent();
